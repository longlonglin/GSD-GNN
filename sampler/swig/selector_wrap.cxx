...
#define SWIGTYPE_p_StepSelector swig_types[0]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__selector

#else
#  define SWIG_init    init_selector

#endif
#define SWIG_name    "_selector"
...
SWIGINTERN PyObject *_wrap_run(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "run" "', argument " "1"" of type '" "int""'");
  } 
